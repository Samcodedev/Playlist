...
function currentTiming(){
    durat.textContent = (play.currentTime / 60).toFixed(2)
    totalT.textContent = (play.duration / 60).toFixed(2)
    ...
    range.setAttribute("value", play.currentTime)
    if(range.value > play.currentTime + parseFloat(1)){
        play.currentTime = range.value
    }else if(range.value < play.currentTime - parseFloat(1)){
        play.currentTime = range.value
    }
    range.value = play.currentTime

    if(range.value + parseFloat(1) < play.currentTime ){
        play.currentTime = range.value
    }
    range.value = play.currentTime
